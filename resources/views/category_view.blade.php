...
<div class="hero-section hero-background">
   <input class="cat_name" value="{{$catName}}" type="hidden" name="">
               ...
               <ul class="products-list">
                  ...
                  <li class="product-item col-lg-3 col-md-4 col-sm-4 col-xs-6 queried">
                     <div class="contain-product layout-default">
                        <div class="product-thumb">
                           @if ($allProduct->tag !=='null')
                              <h4 style="color:white;font-weight:bold;background:orange;padding:5px 8px;position: absolute;top:0;right:0;"> {{$allProduct->tag }} </h4>
                           @endif
...
$(".load, .price, .brand, .color, .size").click(function(){
    ...
    infinteLoadMore(cat_name, page,$given_price1, $given_price2, $colors, $sizes, $brands); //passing 
});
...
function infinteLoadMore(cat_name, page,$given_price1, $given_price2, $colors, $sizes, $brands) {
    $.ajax({
            url: ENDPOINT+"/cat_load?page=" + page,
            datatype: "html",
            type: "get",
            data: {
                cat_name: cat_name, 
