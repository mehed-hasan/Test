    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                Category " <span class="spec_name"> </span> " will be delete and it will never overcome.
            </div>
            <div class="modal-footer">
                <form action="{{route('admin.cat_delete')}}" method="POST">
                    @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$data->cat_name}}</td>
                                            <td ><img class="min_img img-thumbnail" src="{{ asset('uploads/cat_images/'.$data->cover_img) }}" alt="" srcset=""></td>
                                            <td>Mehedi</td>
                                            <td><a class="btn btn-default" href="/admin/edit_cat/{{$data->id}}">Edit</a> ||  <a href="#" data-cat_name={{$data->cat_name}}  data-id="{{$data->id}}" class="delete_btn btn btn-danger" data-toggle="modal" data-target="#defaultModal">
                                                Delete
                                            </a></td>
                                        </tr>
                                        @endforeach
