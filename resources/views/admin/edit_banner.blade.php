                    ...
                    <div class="card">
                        <div class="header">
                          ...
                          @endif
                            ...
                            <form action="/admin/update_banner/{{$datas->id}}/{{$datas->cover_img}}" enctype="multipart/form-data" method="POST">
                               @csrf
                                ...
                                <div class="form-group form-float">
                                    <textarea placeholder="Write short text"  minlength="15" maxlength="100"  class="form-control" name="short_desc" id="" cols="10" rows="10">{{$datas->short_desc}}</textarea>
                                </div>
                                ...
                                <div class="row preview">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                         <div class="input-group col-xs-12">
                                          ...
                                          <img style="max-width: 250px;" class="img-responsive img-thumbnail" src="{{asset('')}}uploads/banner_images/{{$datas->cover_img}}"  id="img1"  alt="No Image Selected">
                                      </div>
                                </div>
                                <br>
