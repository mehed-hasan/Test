                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td ><img class="min_img img-thumbnail" src="{{ asset('uploads/banner_images/'.$data->cover_img) }}" alt="" srcset=""></td>
                                            <td>{{$data->heading}}</td>
                                            <td>{{$data->short_desc}}</td>
                                            <td><a class="btn btn-default" href="/admin/edit_banner/{{$data->id}}">Edit</a> ||  <a href="#" data-heading={{$data->heading}}  data-id="{{$data->id}}" class="delete_btn btn btn-danger" data-toggle="modal" data-target="#defaultModal">
                                                Delete
                                            </a></td>
                                        </tr>
                                        @endforeach
