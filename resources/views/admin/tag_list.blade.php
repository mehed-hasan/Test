    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                tag " <span class="spec_name"> </span> " will be delete and it will never overcome.
            </div>
            <div class="modal-footer">
                <form action="{{route('admin.tag_delete')}}" method="POST">
                    @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$data->tag_name}}</td>
                                            <td><a href="#" data-tag_name={{$data->tag_name}}  data-id="{{$data->id}}" class="delete_btn btn btn-danger" data-toggle="modal" data-target="#defaultModal">
                                                Delete
                                            </a></td>
                                        </tr>
                                        @endforeach
...
<script>
    $(".delete_btn").click(function(){
        $spec_name = $(this).attr('data-tag_name');
