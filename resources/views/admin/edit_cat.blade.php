                    ...
                    <div class="card">
                        <div class="header">
                          ...
                          @endif
                            ...
                            <form action="/admin/update_cat/{{$datas->id}}/{{$datas->cover_img}}/{{$datas->cat_name}}" enctype="multipart/form-data" method="POST">
                               @csrf
                                <div class="form-group form-float">
                                    <input value="{{$datas->cat_name}}"  type="text" class="form-control" placeholder="Category Name " name="cat_name" >
                                </div>
                                ...
                                <div class="row preview">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                         <div class="input-group col-xs-12">
                                          ...
                                          <img style="max-width: 250px;" class="img-responsive img-thumbnail" src="{{asset('uploads/cat_images/'.$datas->cover_img)}}"  id="img1"  alt="No Image Selected">
                                      </div>
                                </div>
                                <br>
