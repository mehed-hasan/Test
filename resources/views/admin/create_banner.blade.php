                            ...
                            <form action="/admin/insert_banner" enctype="multipart/form-data" method="POST">
                               @csrf
                                <div class="form-group form-float">
                                    <input placeholder="Write banner heading "  minlength="5" maxlength="34"  type="text" class="form-control" placeholder="Heading  " name="heading_name" >
                                </div>
                                <div class="form-group form-float">
                                    <textarea placeholder="Write short text"  minlength="15" maxlength="100"  class="form-control" name="short_desc" id="" cols="5" rows="5"></textarea>
                                </div>
