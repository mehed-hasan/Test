    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('admin.reloader_delete')}}" method="POST">
                    @csrf
        ...
        <div class="container">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Reloaders</strong>Lists </h2>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->id}}</td>
                                            <td>{{$data->tranx}}</td>
                                            <td>{{$data->tranx_amount}}</td>

                                            <td><a href="/admin/reloader_approve/{{$data->id}}/{{$data->tranx_amount}}"  class="delete_btn btn btn-success" >
                                                Approve
                                            </a></td>
{{-- 
