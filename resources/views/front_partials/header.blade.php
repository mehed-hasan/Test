                ...
                <div class="col-lg-2 col-sm-3 col-5">
                    <div class="header-brand">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <img src="{{asset('front/images/logo/logo-light.png')}}" alt="Site Logo">
                        </a>
                    </div>
                </div>
                            ...
                            <ul class="nav-menu-list">
                                <li>
                                    <a href="#" class="nav-link has-megamenu">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-01.png')}}" alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link has-megamenu">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-02.png')}}" alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link has-megamenu">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-03.png')}}" alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-04.png')}}" alt="Department"></span>
                                        <span class="menu-text">Medicine</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-05.png')}}" alt="Department"></span>
                                        <span class="menu-text">Furniture</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-06.png')}}" alt="Department"></span>
                                        <span class="menu-text">Crafts</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-07.png')}}" alt="Department"></span>
                                        <span class="menu-text">Accessories</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img src="{{asset('front/images/product/categories/cat-08.png')}}" alt="Department"></span>
