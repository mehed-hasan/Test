@extends('layout')
        ...
        <div class="hero-section hero-background">
            <div class="hero-section hero-background">
                <input class="subsubcat_name" value="{{$subsubCatDatas->sub_sub_cat}}  " type="hidden" name="">
                <h1 class="page-title">{{$subsubCatDatas->cat_name}} / {{$subsubCatDatas->sub_cat}} / {{$subsubCatDatas->sub_sub_cat}} </h1>
            </div>
        </div>
                    ...
                    <div class="widget biolife-filter">
                       ...
                       <div class="wgt-content">
                          <ul class="cat-list">
                             ...
                             <li class="cat-list-item"><a href="/sub_category_view/{{$allCat->id}}/{{$allCat->sub_cat}}" class="cat-link"> {{$allCat->sub_cat}} </a></li>
                             @endforeach
                          </ul>
                       </div>
                    </div>
        ...
        var ENDPOINT = "{{ url('/') }}";
        var page = 0;
        var subsubcat_name = $(".subsubcat_name").val();
        $('.auto-load').hide();
        ...
        $(".load, .price, .brand, .color, .size").click(function(){
            ...
            infinteLoadMore(subsubcat_name, page,$given_price1, $given_price2, $colors, $sizes, $brands); //passing 
        });
        ...
        function infinteLoadMore(subsubcat_name, page,$given_price1, $given_price2, $colors, $sizes, $brands) {
            $.ajax({
                    url: ENDPOINT+"/subsubcat_load?page=" + page,
                    datatype: "html",
                    type: "get",
                    data: {
